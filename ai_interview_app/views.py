...
from ai_interview_app.forms import ResumeUploadForm, AnswerForm
...
def verification(request):
    if request.method == 'POST':
        ...
        return render(request, 'ai_interview_app/verification.html', {'candidate_image_path': candidate_image_path})
...
def index(request, interview_type=None):
    ...
    return render(request, 'ai_interview_app/index.html', {'form': form, 'interview_type': interview_type})
...
def question(request, interview_type):
    ...
    return render(request, 'ai_interview_app/question.html', {
...
def results(request):
        ...
        return render(request, 'ai_interview_app/results.html', context)

def home(request):
        return render(request, 'ai_interview_app/home.html')

def ai_interview_options(request):
        return render(request, 'ai_interview_app/ai_interview_options.html')
